...
$conn = mysqli_connect("database-2.cvdze1lptugg.ap-northeast-2.rds.amazonaws.com","wave2","crss6801!!","richpig") or die ("Can't access DB");
...
//		$d1 = round($d1 / 10,1);
	...
	$sql = "INSERT INTO richpig.raw_data (`create_at`,`address`,`board_type`,`board_number`,`data1`,`data2`,`data3`,`data4`,`data5`,`data6`,`data7`)
