...
$conn = mysqli_connect("database-1.cvdze1lptugg.ap-northeast-2.rds.amazonaws.com","wave2","crss6801!!","ewavetest") or die ("Can't access DB");
...
$control_sql = "select * from control_data where address = $address and board_type = $bd_type and board_number = $bd_number order by create_at desc limit 1 ";
